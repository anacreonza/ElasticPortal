        ...
        <div class="story-container">
                <div class="story-item">
                    <table class="table">
                        ...
                        <tr>
                            <td class="story-description-text" colspan="4"><span class="item-label">Content: </span>{!!$display_array[$i]['content']!!}</td>
                        </tr>
                        <tr>
                            <td colspan="2" class="story-description-text"><span class="item-label">Keywords: </span>{{$display_array[$i]['keywords']}}</td>
